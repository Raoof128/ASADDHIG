...
for key in [
    "OPENAI_API_KEY", "OPENAI_BASE_URL", "OPENAI_MODEL", "OPENAI_TIMEOUT", "OPENAI_MAX_TOKENS",
    "OLLAMA_BASE_URL", "OLLAMA_MODEL", "OLLAMA_TIMEOUT",
    "PII_THRESHOLD", "GATEWAY_HOST", "GATEWAY_PORT", "GATEWAY_LOG_LEVEL",
    "MAX_REQUEST_SIZE", "ENABLE_CORS", "CORS_ORIGINS",
    "AUDIT_LOG_FILE", "AUDIT_LOG_LEVEL",
    ...
    if env_value is not None:
        ...
        attr_name = key.lower()
        if key.endswith("_TIMEOUT") or key.endswith("_PORT") or key.endswith("_SIZE") or key.endswith("_PER_MINUTE"):
